...
def account():
	...
	if form.validate_on_submit():
		if form.picture.data:
			...
			current_user.img = picture_file  #img is the column name for image in db look for User class in the models.py 
...
def reset_request():
	...
	if form.validate_on_submit():
		...
		flash("An emial has been sent with instructions to reset your password.", 'info')
		return redirect(url_for('users.login'))
